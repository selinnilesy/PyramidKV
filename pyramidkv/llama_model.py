...
class LlamaSdpaAttention(CustomLlamaAttention):
    def forward(
        self,
        hidden_states: torch.Tensor,
        attention_mask: Optional[torch.Tensor] = None,
        ...
        if output_attentions:
            ...
            print("Hello from SUPER llama_sdpa_attn_forward_PyramidKV")
...
def llama_flash_attn2_forward_H2O(
    ...
    **kwargs,
    ...
    output_attentions = False
    print("Hello from llama_flash_attn2_forward_H2O forward")
